...
##       probably should make /YYYY/ the final GCS path.
  ...
  do  
    ...
    --replace "SELECT * FROM \`mlab_statistics.continent_country_histogram\` WHERE continent_code = \"${continent}\" AND country_code = \"${country}\" ORDER BY test_date, continent_code, county_code, country_name, bucket_min, bucket_max, frac, samples")
    ...
    bq extract --destination_format NEWLINE_DELIMITED_JSON \
      ...
      gs://temp_generate_stats/${continent}/${country}/histogram_daily_stats.json      
