...
d7_download AS (
  ...
  GROUP BY continent_code, country_code, country_name, ISO3166_2region1, city
),
last7d_up AS (
...
JOIN d7_download USING (continent_code, country_code, country_name, ISO3166_2region1, city)
JOIN d7_upload USING (continent_code, country_code, country_name, ISO3166_2region1, city)
JOIN d30_download USING (continent_code, country_code, country_name, ISO3166_2region1, city)
JOIN d30_upload USING (continent_code, country_code, country_name, ISO3166_2region1, city)
JOIN d60_download USING (continent_code, country_code, country_name, ISO3166_2region1, city)
JOIN d60_upload USING (continent_code, country_code, country_name, ISO3166_2region1, city)
JOIN d90_download USING (continent_code, country_code, country_name, ISO3166_2region1, city)
JOIN d90_upload USING (continent_code, country_code, country_name, ISO3166_2region1, city)
JOIN d180_download USING (continent_code, country_code, country_name, ISO3166_2region1, city)
JOIN d180_upload USING (continent_code, country_code, country_name, ISO3166_2region1, city)
JOIN d365_download USING (continent_code, country_code, country_name, ISO3166_2region1, city)
JOIN d365_upload USING (continent_code, country_code, country_name, ISO3166_2region1, city)
