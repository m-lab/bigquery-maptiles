...
SELECT
    ...
    zipcodes.county AS county,
    zipcodes.zip_code_geom AS WKT
FROM
  `bigquery-public-data.geo_us_boundaries.zip_codes` zipcodes
  LEFT JOIN main_2020w1 ON zipcodes.zip_code = zipcode
  LEFT JOIN main_2020w2 USING (zipcode)
  LEFT JOIN main_2020w3 USING (zipcode)
  LEFT JOIN main_2020w4 USING (zipcode)
  LEFT JOIN main_2020w5 USING (zipcode)
  LEFT JOIN main_2020w6 USING (zipcode);
